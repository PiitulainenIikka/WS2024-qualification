...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" novalidate action="{{ url('/api/ticket/create/'.$event->id)}}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control {{$errors->has('amount') ? 'is-invalid' : ''}}" id="inputAmount" name="amount" placeholder="">
                        <div class="invalid-feedback">
                            @error('amount')
                                {{ $message }}
                            @enderror
